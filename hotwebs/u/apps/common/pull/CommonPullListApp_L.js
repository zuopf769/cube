...
var CommonPullListViewModel = function (name) {
    cb.model.ContainerModel.call(this, null, name || "CommonPullListViewModel");
    this.init();
};
CommonPullListViewModel.prototype = new cb.model.ContainerModel();
CommonPullListViewModel.prototype.constructor = CommonPullListViewModel;

CommonPullListViewModel.prototype.init = function () {
    var fields = {
        ViewModelName: "CommonPullListViewModel",
        Symbol: "UAP",
        ...
        partheadtable: new cb.model.Model3D({
            title: "表头", ctrlType: "DataGrid", dsMode: "false", ReadOnly: true, height: 200,pageSize:-1,
            //Columns: {
            //    customer: { title: "客户名称", ctrlType: "TextBox" },
            //    saler: { title: "销售员", ctrlType: "TextBox" },
            //    pkorg: { title: "部门", ctrlType: "TextBox" },
        ...
        partbodytable: new cb.model.Model3D({
            title: "表体", ctrlType: "DataGrid", dsMode: "false", ReadOnly: true, height: 300,pager:'pager1',
            //Columns: {
    ...
    //this.getpartbodytable().on("afterCellValueChange", function (args) { CommonPullListViewModel_Extend.bCellValueChange(this.getParent(), args); });
...
CommonPullListViewModel.prototype.initData = function () {
