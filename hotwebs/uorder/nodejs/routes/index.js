...
router.get("/upservices/getHomeProducts", function (req, res) {
    Application.renderJson(res, mockData.getHomeProducts());
});
router.get("/upservices/getAllProducts", function (req, res) {
    Application.renderJson(res, mockData.getAllProducts());
});
router.get("/upservices/getProductDetail", function (req, res) {
    Application.renderJson(res, mockData.getProductDetail());
});
...
router.get("/upservices/getAllOrderLists", function (req, res) {
    Application.renderJson(res, mockData.getAllOrderLists());
});
router.get("/upservices/getCartInfo", function (req, res) {
    Application.renderJson(res, mockData.getCartInfo());
});
router.get("/upservices/getCategoryContents", function (req, res) {
    Application.renderJson(res, mockData.getCategoryContents());
});
router.get("/upservices/getCategorys", function (req, res) {
    Application.renderJson(res, mockData.getCategorys());
});
