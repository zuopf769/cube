...
UOrderApp.pages.DeliveryListController.prototype.pageInit = function (page) {
    var self = this;
    if (page.query.cOrderNo) {
        self.cOrderNo = page.query.cOrderNo;
    }
    var params = {
        pageSize: 10,
        pageIndex: 1,
        cOrderNo: self.cOrderNo
    };

    //下拉刷新
    $$('.pull-to-refresh-content.deliveryList-container').on('refresh', function (e) {
        self.getDeliveryList(params, function (data) {
...
UOrderApp.pages.DeliveryListController.prototype.getDeliveryList = function (params, callback) {
    var self = this;
